...
class Solution(BaseSolution):
    ...
    def solve(self, s: str) -> int:
        ...
        for scanner1, scanner2 in itertools.combinations(scanners, 2):
            assert scanner1.pos is not None
            assert scanner2.pos is not None
            max_dist = max(manhattan_distance(scanner1.pos, scanner2.pos), max_dist)
        return max_dist
